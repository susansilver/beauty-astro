...
<BlockQuoteBook quote="Beauty is the first test: there is no permanent place in the world for ugly mathematics." cite="- G.H. Hardy " />  
...
import basetwelve from '../../assets/Base-12-768x129.png';

<Image src={basetwelve} alt="Dozenal Bookmark with Dek,El, and Do digits in blue" format="avif" quality="mid" />
